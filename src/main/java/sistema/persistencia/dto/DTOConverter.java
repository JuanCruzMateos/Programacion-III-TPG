...
public class DTOConverter {
    ...
    public static ClinicaDTO ClinicaDTOFromClinica() {
        ...
        clinicaDTO.setModuloAtencionAmbulatoria(Clinica.getInstance().getModuloAtencionAmbulatoria());
    ...
    public static void ClinicaFromClinicaDTO(ClinicaDTO clinicaDTO) {
        ...
        Clinica.getInstance().setModuloAtencionAmbulatoria(clinicaDTO.getModuloAtencionAmbulatoria());
