...
//            clinica.facturar(paciente3, new GregorianCalendar(2021, Calendar.JANUARY, 23), consultaMedicas3, internacions3);
            ...
            try {
                Clinica.getInstance().agregarAsociado("juan", "Peres", "direccion", 12346L, 12346);
                Clinica.getInstance().agregarAsociado("federico", "Peres", "direccion", 12346L, 167498);
                Clinica.getInstance().agregarAsociado("pablo", "Peres", "direccion", 12346L, 31325);
            } catch (AsociadoExistenteException exception1) {
                e.printStackTrace();
            }
        }
    }
