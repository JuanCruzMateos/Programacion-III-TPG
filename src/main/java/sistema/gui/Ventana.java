...
public class Ventana extends JFrame implements ListSelectionListener, IVista {
    ...
    public Ventana() {
        ...
        BotonAgregarAsociado.addActionListener(Controlador.getInstance());
        ...
        BotonEliminarAsociado.addActionListener(Controlador.getInstance());
        ...
        btnNuevaSimulacion.addActionListener(Controlador.getInstance());
        ...
        btnComenzarSimulacion.addActionListener(Controlador.getInstance());
        ...
        btnAñadirSolicitud.addActionListener(Controlador.getInstance());
