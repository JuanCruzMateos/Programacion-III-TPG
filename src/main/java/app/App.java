...
import sistema.persistencia.PersistenciaXML;
...
public class App {
    public static void main(String[] args) {
        AccesoDatos.initClinica("clinica.xml");
        Controlador.getInstance().setClinica(Clinica.getInstance());
        Controlador.getInstance().setVista(new Ventana());
        Controlador.getInstance().Inicializar();
...
//
//        try {
//            Clinica.getInstance().agregarAsociado("juan", "Peres", "direccion", 12346, 12346);
//            Clinica.getInstance().agregarAsociado("federico", "Peres", "direccion", 12346, 167498);
//            Clinica.getInstance().agregarAsociado("pablo", "Peres", "direccion", 12346, 31325);
...
//            persistenciaXML.openInput("clinica.xml");
//            ClinicaDTO clinicaDTO = (ClinicaDTO) persistenciaXML.read();
//            DTOConverter.ClinicaFromClinicaDTO(clinicaDTO);
//            persistenciaXML.closeInput();
//            System.out.println(Clinica.getInstance().estadoDeLaClinica());
//            System.out.println(Clinica.getInstance().getModuloEgreso().getFactura(1));
//            System.out.println(Clinica.getInstance().getModuloEgreso().getFactura(2));
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
